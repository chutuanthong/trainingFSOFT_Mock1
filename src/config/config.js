...
const envVarsSchema = Joi.object()
  .keys({
    ...
    TWILIO_SID: Joi.string().description(
      "Account SID from www.twilio.com/console"
    ),
    TWILIO_TOKEN: Joi.string().description(
      "Auth Token from www.twilio.com/console"
    ),
    TWILIO_SERVICE_ID: Joi.string().description(
      "Service ID from www.twilio.com/console"
    ),
    ...
    CLOUD_API_SECRET: Joi.string().description(
      "cloud api secret from cloudinary"
    ),
  })
  .unknown();
